...
@InputType()
class RecommendationCreateNestedManyWithoutPlacesInput {
...
export { RecommendationCreateNestedManyWithoutPlacesInput as RecommendationCreateNestedManyWithoutPlacesInput };
